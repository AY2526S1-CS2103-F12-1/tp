...
public class MainWindow extends UiPart<Stage> {
    ...
    @FXML
    private StackPane organizationPanelPlaceholder;
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getHenriFilePath());
     ...
     *
     * @see seedu.henri.logic.Logic#execute(String)
     */
